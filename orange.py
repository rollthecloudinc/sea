...
if __name__ == "__main__":
    ...
    grayscale_output_path = "grayscale_orange_output.jpg"  # Path for grayscale output
    transparent_overlay_output_path = "transparent_orange_overlay_output.png"  # Path for transparent overlay output
