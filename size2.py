...
def detect_shapes_with_depth(image_path, output_depth_path, output_shapes_path):
    ...
    plt.axis("off")
    plt.savefig("output_shapes_plot.jpg")  # Save the plot to a file
    print("Plot saved as output_shapes_plot.jpg")
...
if __name__ == "__main__":
    ...
    output_shapes_path = "output_shapes_with_depth2.jpg"  # Replace with your desired shape annotation file path
