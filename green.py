...
if __name__ == "__main__":
    ...
    grayscale_output_path = "grayscale_green_output.jpg"  # Path for grayscale output
    transparent_overlay_output_path = "transparent_green_overlay_output.png"  # Path for transparent overlay output
