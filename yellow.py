...
if __name__ == "__main__":
    ...
    grayscale_output_path = "grayscale_yellow_output.jpg"  # Path for grayscale output
    transparent_overlay_output_path = "transparent_yellow_overlay_output.png"  # Path for transparent overlay output
